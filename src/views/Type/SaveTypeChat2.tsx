...
const SaveTypeChat2: React.FC = () => {
  ...
  const handleDiscard = async () => {
    ...
    try {
      await deleteDoc(doc(db, "typejournal", docId));
  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      setIsAnalyzed(true);
      const journalRef = doc(db, "typejournal", docId);

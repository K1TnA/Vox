...
const SaveTypeChat: React.FC = () => {
  ...
  const handleDiscard = async () => {
    ...
    try {
      await deleteDoc(doc(db, "typechatjournal", docId));
  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      setIsAnalyzed(true);
      const journalRef = doc(db, "typechatjournal", docId);
